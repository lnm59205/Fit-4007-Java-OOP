...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            try {
                ...
                System.out.println("Lựa chọn không hợp lệ. Vui lòng nhập số từ 1 đến 9.");
                continue;
            }
    ...
    // Phương thức thêm cầu thủ với xử lý ngoại lệ
    ...
    // Phương thức thêm trận đấu với xử lý ngoại lệ
    ...
    // Phương thức tìm kiếm cầu thủ với xử lý ngoại lệ
    ...
    // Phương thức xóa cầu thủ với xử lý ngoại lệ
    ...
    // Phương thức cập nhật cầu thủ với xử lý ngoại lệ
